...
import type { RequirementDetailRow } from '@/dal/requirements'
...
export function RequirementDetailView({ requirement: req, assignees }: Props) {
      ...
      <div>
        ...
        <div className="flex items-center gap-4 mt-3 text-sm text-muted-foreground">
          ...
          {req.kind === 'payment' && req.amount_cents && (
            <span>${(req.amount_cents / 100).toFixed(2)}</span>
          )}
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              {req.kind === 'payment' && <TableHead>Progress</TableHead>}
